            ...
            <div className="row" style={{ padding: "20px", display: "flex", flexDirection: "row" }}>
                ...
                <div className="col-12 col-md-6" style={{ display: "flex", flexDirection: "column" }}>
                    <form onSubmit={handleSubmit}
                        ...
                        <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}> Tên ngân hàng
                            <input
                                type="text"
                                value={bankName}
                        ...
                        {/* Số tài khoản */}
                        <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}> Số tài khoản
                            <input
                                type="text"
                                value={bankName}
                                onChange={(e) => setBankName(e.target.value)}
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '20px' }}>
                            <button type="submit" style={style.viewMoreButton}>Gửi</button>
                        </div>
                    </form>
                </div>
            </div>
