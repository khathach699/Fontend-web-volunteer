    ...
    <div className="h-screen w-sm bg-white ">
      ...
      <Link to="/Admin/Statistics">
        <button
          ...
          style={{
            backgroundColor:
              currentPage === "/Admin/Statistics" ? "#EDF1D6" : "#ffffff",
          }}
        >
          <h4>Thống kê</h4>
        </button>
      ...
      <Link to="/Admin/VolunteerManagement">
        <button
          ...
          style={{
            backgroundColor:
              currentPage === "/Admin/VolunteerManagement"
                ? "#EDF1D6"
                : "#ffffff",
          }}
        >
      ...
      <Link to="/Admin/OriginManagement">
        <button
          ...
          style={{
            backgroundColor:
              currentPage === "/Admin/OriginManagement" ? "#EDF1D6" : "#ffffff",
          }}
        >
      ...
      <Link to="/Admin/PostManagement">
        <button
          ...
          style={{
            backgroundColor:
              currentPage === "/Admin/PostManagement" ? "#EDF1D6" : "#ffffff",
          }}
        >
      ...
      <Link to="/Admin/CampainManagement">
        <button
          ...
          style={{
            backgroundColor:
              currentPage === "/Admin/CampainManagement"
                ? "#EDF1D6"
                : "#ffffff",
          }}
        >
